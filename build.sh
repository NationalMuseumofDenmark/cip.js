...
$CLOSURE_COMPILER vendor/qwest.js src/cip-common.js src/cip-catalog.js src/cip-table.js src/cip-layout.js src/cip-asset.js src/cip-searchresult.js src/cip.js >> dist/cip.min.js;
$CLOSURE_COMPILER dist/cip.min.js src/natmus.js >> dist/cip+natmus.min.js

zip -r dist/cip+natmus.zip doc;
