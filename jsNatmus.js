...
function Natmus() {
    this.CIP_URL = "http://samlinger.natmus.dk/";

    this.session_open = function() {
    qwest.get(this.CIP_URL + "CIP/session/open")
  ...
  this.search = function() {
    qwest.get(this.CIP_URL + "CIP/metadata/search/mycatalog/myfields?quicksearchstring=zebra");
  };
